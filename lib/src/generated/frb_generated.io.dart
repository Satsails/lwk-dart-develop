...
abstract class LwkCoreApiImplPlatform extends BaseApiImpl<LwkCoreWire> {
  ...
  @protected
  ffi.Pointer<wire_cst_list_asset_recipient> cst_encode_list_asset_recipient(
      List<AssetRecipient> raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ans = wire.cst_new_list_asset_recipient(raw.length);
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_asset_recipient(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  @protected
  void cst_api_fill_to_wire_asset_recipient(
      AssetRecipient apiObj, wire_cst_asset_recipient wireObj) {
    wireObj.address = cst_encode_String(apiObj.address);
    wireObj.sats = cst_encode_u_64(apiObj.sats);
...
class LwkCoreWire implements BaseWire {
  ...
  void wire__crate__api__wallet__wallet_build_asset_tx_multi(
    int port_,
    ffi.Pointer<wire_cst_wallet> that,
    ffi.Pointer<wire_cst_list_asset_recipient> recipients,
    double fee_rate,
  ) {
    return _wire__crate__api__wallet__wallet_build_asset_tx_multi(
      port_,
      that,
      recipients,
      fee_rate,
  ...
  late final _wire__crate__api__wallet__wallet_build_asset_tx_multiPtr =
      _lookup<
              ffi.NativeFunction<
                  ffi.Void Function(
                    ffi.Int64,
                    ffi.Pointer<wire_cst_wallet>,
                    ffi.Pointer<wire_cst_list_asset_recipient>,
                    ffi.Float,
                  )>>(
          'frbgen_lwk_wire__crate__api__wallet__wallet_build_asset_tx_multi');
  late final _wire__crate__api__wallet__wallet_build_asset_tx_multi =
      _wire__crate__api__wallet__wallet_build_asset_tx_multiPtr.asFunction<
          void Function(
            int,
            ffi.Pointer<wire_cst_wallet>,
            ffi.Pointer<wire_cst_list_asset_recipient>,
  ...
  ffi.Pointer<wire_cst_list_asset_recipient> cst_new_list_asset_recipient(
    int len,
  ) {
    return _cst_new_list_asset_recipient(len);
  }

  late final _cst_new_list_asset_recipientPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_asset_recipient> Function(
              ffi.Int32)>>('frbgen_lwk_cst_new_list_asset_recipient');
  late final _cst_new_list_asset_recipient = _cst_new_list_asset_recipientPtr
      .asFunction<ffi.Pointer<wire_cst_list_asset_recipient> Function(int)>();
...
final class wire_cst_asset_recipient extends ffi.Struct {
...
final class wire_cst_list_asset_recipient extends ffi.Struct {
  external ffi.Pointer<wire_cst_asset_recipient> ptr;
